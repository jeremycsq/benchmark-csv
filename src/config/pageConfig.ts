    ...
    yoyMetrics: [
      {
        ...
        description: 'YoY change in conversion rate (CVR).',
      },
      {
        value: '+0%',
        label: 'Cart Abandonment rate',
        description: 'YoY change in cart abandonment rate.',
        isRounded: true,
      },
      {
        value: '+0%',
        label: 'Average Order Value',
        description: 'YoY change in average order value (AOV).',
      },
      {
        value: '+0%',
        label: 'Revenue Per Session',
        description: 'YoY change in revenue per session (RPV).',
        isRounded: true,
      },
    ],
    momMetrics: [
      {
        value: '+0%',
        label: 'Conversion rate',
        description: 'MoM change in conversion rate (CVR).',
      },
      {
        value: '+0%',
        label: 'Cart Abandonment rate',
        description: 'MoM change in cart abandonment rate.',
        isRounded: true,
      },
      {
        value: '+0%',
        label: 'Average Order Value',
        description: 'MoM change in average order value (AOV).',
      },
      {
        value: '+0%',
        label: 'Revenue Per Session',
        description: 'MoM change in revenue per session (RPV).',
        isRounded: true,
      },
    ],
  },
